...
public class Wrecks {
	...
	public static WreckEvent coldCaverns() {
		return new WreckEvent().monsters(
				new MonsterSet("husks", false, 50).allowatstart(true).monsters(
						...
						new MonsterEvent(Character.Husk, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 1, 1).spawndistance(1000)),
				new MonsterSet("crawlers", false, 30).allowatstart(true).monsters(
						new MonsterEvent(Character.Crawler, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Crawler, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 1, 3).spawnprobability(0.5).spawndistance(1000)),
				new MonsterSet("mudraptors", false, 20).allowatstart(true).monsters(
						...
						new MonsterEvent(Character.Mudraptor, 0, 2).spawndistance(1000)),
				new MonsterSet("hammerheads", false, 10).allowatstart(true).monsters(
						new MonsterEvent(Character.Hammerhead, 1, 1).spawndistance(1000)));
	}
	...
	public static WreckEvent europanRidge() {
		return new WreckEvent().monsters(
				new MonsterSet("husks", false, 50).allowatstart(true).monsters(
						new MonsterEvent(Character.Husk, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Husk, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Husk, 0, 2).spawndistance(1000),
						new MonsterEvent(Character.Husk, 0, 2).spawndistance(1000),
				...
				new MonsterSet("crawlers", false, 30).allowatstart(true).monsters(
						...
						new MonsterEvent(Character.Crawler, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Crawler, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 0, 3).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 0, 3).spawndistance(1000)),
				new MonsterSet("mudraptors", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Mudraptor_unarmored, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_unarmored, 1, 2).spawndistance(1000),
						...
						new MonsterEvent(Character.Mudraptor, 0, 2).spawndistance(1000)),
				new MonsterSet("hammerheads", false, 10).allowatstart(true).monsters(
						new MonsterEvent(Character.Hammerhead, 1, 3).spawndistance(1000).scatter(1000)));
	}
	...
	public static WreckEvent aphoticPlateau1() {
		return new WreckEvent().monsters(
				...
				new MonsterSet("crawlers", false, 30).allowatstart(true).monsters(
						...
						new MonsterEvent(Character.Crawler, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Crawler, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 1, 3).spawndistance(1000)),
				new MonsterSet("mudraptors", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Mudraptor_unarmored, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_unarmored, 1, 2).spawndistance(1000),
						...
						new MonsterEvent(Character.Mudraptor, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Watcher, 0, 1).spawndistance(1000)),
				new MonsterSet("threshers", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Tigerthresher, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher, 1, 2).spawndistance(1000)),
				new MonsterSet("hammerheads", false, 10).allowatstart(true).monsters(
	...
	public static WreckEvent aphoticPlateau2() {
		return new WreckEvent().monsters(
				new MonsterSet("husks", false, 50).allowatstart(true).monsters(
						new MonsterEvent(Character.Husk, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Husk, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Husk, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Husk, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 1, 2).spawndistance(1000)),
				new MonsterSet("crawlers", false, 30).allowatstart(true).monsters(
						new MonsterEvent(Character.Crawler, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Crawler, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Crawler, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Crawler, 1, 3).spawndistance(1000)),
				new MonsterSet("mudraptors", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Mudraptor_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 2, 3).spawndistance(1000)),
				...
				new MonsterSet("cavebonethreshers", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Bonethresher_cave, 1, 1).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 1, 1).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 1, 1).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 0, 1).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 0, 1).spawndistance(1000)),
				new MonsterSet("hammerhead_juvenile", false, 10).allowatstart(true).monsters(
						new MonsterEvent(Character.Hammerhead_juvenile, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Hammerhead_juvenile, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Hammerhead_juvenile, 1, 2).spawndistance(1000),
						new MonsterEvent(Character.Hammerhead_juvenile, 1, 1).spawndistance(1000),
						new MonsterEvent(Character.Hammerhead_juvenile, 1, 1).spawndistance(1000)),
				new MonsterSet("hammerheadsblack", false, 10).allowatstart(true).monsters(
	...
	public static WreckEvent greatSea() {
		return new WreckEvent().monsters(
				new MonsterSet("husks", false, 50).allowatstart(true).monsters(
						new MonsterEvent(Character.Husk, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Husk, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Husk, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Husk, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 3, 5).spawndistance(1000)),
				new MonsterSet("crawlers", false, 30).allowatstart(true).monsters(
						new MonsterEvent(Character.Crawler_veteran, 2, 4).spawndistance(1000),
						new MonsterEvent(Character.Crawler_veteran, 2, 4).spawndistance(1000),
						new MonsterEvent(Character.Crawler_veteran, 2, 4).spawndistance(1000),
						new MonsterEvent(Character.Crawler_veteran, 2, 4).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 3, 4).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 3, 4).spawndistance(1000)),
				new MonsterSet("mudraptors", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Mudraptor_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 2, 3).spawndistance(1000),
						...
						new MonsterEvent(Character.Mudraptor_veteran, 2, 3).spawndistance(1000)),
				new MonsterSet("tigerthreshers", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Tigerthresher_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher_veteran, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher_veteran, 2, 3).spawndistance(1000)),
				new MonsterSet("cavebonethreshers", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Bonethresher_cave, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 1, 3).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 1, 3).spawndistance(1000)),
				new MonsterSet("hammerhead_juvenile", false, 10).allowatstart(true).monsters(
						new MonsterEvent(Character.Hammerhead_juvenile, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Hammerhead_juvenile, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Hammerhead_juvenile, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Hammerhead_juvenile, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Hammerhead_juvenile, 2, 3).spawndistance(1000)),
	...
	public static WreckEvent hydrothermalWastes() {
		return new WreckEvent().monsters(
				new MonsterSet("husks", false, 50).allowatstart(true).monsters(
						...
						new MonsterEvent(Character.Crawlerhusk, 3, 5).spawndistance(1000)),
				new MonsterSet("crawlers", false, 30).allowatstart(true).monsters(
						new MonsterEvent(Character.Crawler_veteran, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Crawler_veteran, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Crawler_veteran, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Crawler_veteran, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Crawlerhusk, 3, 5).spawndistance(1000)),
				new MonsterSet("mudraptors", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Mudraptor_veteran, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 3, 5).spawndistance(1000),
						new MonsterEvent(Character.Mudraptor_veteran, 3, 5).spawndistance(1000)),
				new MonsterSet("tigerthreshers", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Tigerthresher_veteran, 3, 4).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher_veteran, 3, 4).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher_veteran, 3, 4).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher_veteran, 3, 4).spawndistance(1000),
						new MonsterEvent(Character.Tigerthresher_veteran, 3, 4).spawndistance(1000)),
				new MonsterSet("cavebonethreshers", false, 20).allowatstart(true).monsters(
						new MonsterEvent(Character.Bonethresher_cave, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 2, 3).spawndistance(1000),
						new MonsterEvent(Character.Bonethresher_cave, 2, 3).spawndistance(1000)),
