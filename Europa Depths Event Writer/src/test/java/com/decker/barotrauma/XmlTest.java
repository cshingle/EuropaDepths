...
class XmlTest {
	...
	// @formatter:off
		String expected = 
				"		<!-- 15% or 2 min -->\n"
				+ "    <EventSet identifier=\"first\" chooserandom=\"true\" mindistancetraveled=\"0.15\" minmissiontime=\"120\" delaywhencrewaway=\"true\" minintensity=\"0.0\" maxintensity=\"0.7\">\n"
				+ "      <EventSet identifier=\"hammerheads\" chooserandom=\"false\" commonness=\"20\">\n"
				+ "        <MonsterEvent characterfile=\"Hammerhead\" minamount=\"3\" maxamount=\"4\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "        <MonsterEvent characterfile=\"Hammerheadgold\" minamount=\"1\" maxamount=\"2\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "        <MonsterEvent characterfile=\"Hammerheadmatriarch\" minamount=\"1\" maxamount=\"2\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "      </EventSet>\n"
				+ "      <EventSet identifier=\"molochs\" chooserandom=\"true\" commonness=\"20\">\n"
				+ "        <EventSet identifier=\"nobabies\">\n"
				+ "          <MonsterEvent characterfile=\"Moloch\" minamount=\"1\" maxamount=\"2\" spawntype=\"mainpath,sidepath\" scatter=\"3000\" delaybetweenspawns=\"1\" />\n"
				+ "          <MonsterEvent characterfile=\"Molochblack\" minamount=\"1\" maxamount=\"2\" spawntype=\"mainpath,sidepath\" spawnprobability=\"0.75\" delaybetweenspawns=\"1\" />\n"
				+ "        </EventSet>\n"
				+ "        <EventSet identifier=\"babies\">\n"
				+ "          <MonsterEvent characterfile=\"Moloch\" minamount=\"1\" maxamount=\"2\" spawntype=\"mainpath,sidepath\" offset=\"10000\" scatter=\"3000\" delaybetweenspawns=\"1\" />\n"
				+ "          <MonsterEvent characterfile=\"Molochbaby\" minamount=\"10\" maxamount=\"20\" spawntype=\"mainpath,sidepath\" scatter=\"3000\" delaybetweenspawns=\"1\" />\n"
				+ "        </EventSet>\n"
				+ "      </EventSet>\n"
				+ "      <EventSet identifier=\"spinelings\" chooserandom=\"false\" commonness=\"20\">\n"
				+ "        <MonsterEvent characterfile=\"Spineling\" minamount=\"10\" maxamount=\"12\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "        <MonsterEvent characterfile=\"Spineling_giant\" minamount=\"1\" maxamount=\"2\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "      </EventSet>\n"
				+ "      <EventSet identifier=\"threshers\" chooserandom=\"false\" commonness=\"10\">\n"
				+ "        <MonsterEvent characterfile=\"Bonethresher\" minamount=\"2\" maxamount=\"3\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "        <MonsterEvent characterfile=\"Tigerthresher\" minamount=\"6\" maxamount=\"9\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "      </EventSet>\n"
				+ "      <EventSet identifier=\"mudraptors\" chooserandom=\"false\" commonness=\"10\">\n"
				+ "        <MonsterEvent characterfile=\"Mudraptor\" minamount=\"3\" maxamount=\"4\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "        <MonsterEvent characterfile=\"Mudraptor_veteran\" minamount=\"2\" maxamount=\"2\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "      </EventSet>\n"
				+ "      <EventSet identifier=\"crawlers\" chooserandom=\"true\" commonness=\"10\">\n"
				+ "        <EventSet identifier=\"crawlerswarm\">\n"
				+ "          <MonsterEvent characterfile=\"Crawler\" minamount=\"10\" maxamount=\"12\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "          <MonsterEvent characterfile=\"Crawlerbroodmother\" minamount=\"1\" maxamount=\"1\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "        </EventSet>\n"
				+ "        <EventSet identifier=\"Crawlerhusk\">\n"
				+ "          <MonsterEvent characterfile=\"Crawlerhusk\" minamount=\"10\" maxamount=\"12\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "        </EventSet>\n"
				+ "      </EventSet>\n"
				+ "      <EventSet identifier=\"watcher\" commonness=\"10\">\n"
				+ "        <MonsterEvent characterfile=\"Watcher\" minamount=\"1\" maxamount=\"1\" triggereventcooldown=\"false\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "        <EventSet chooserandom=\"true\">\n"
				+ "          <EventSet identifier=\"crawlers\">\n"
				+ "            <MonsterEvent characterfile=\"Crawler\" minamount=\"9\" maxamount=\"11\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "          </EventSet>\n"
				+ "          <EventSet identifier=\"mudraptors\">\n"
				+ "            <MonsterEvent characterfile=\"Mudraptor\" minamount=\"5\" maxamount=\"5\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "          </EventSet>\n"
				+ "          <EventSet identifier=\"threshers\">\n"
				+ "            <MonsterEvent characterfile=\"Bonethresher\" minamount=\"2\" maxamount=\"3\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "            <MonsterEvent characterfile=\"Tigerthresher\" minamount=\"5\" maxamount=\"8\" spawntype=\"mainpath,sidepath\" delaybetweenspawns=\"1\" />\n"
				+ "          </EventSet>\n"
				+ "        </EventSet>\n"
				+ "      </EventSet>\n"
				+ "    </EventSet>\n";
